    ...
    <div className='RecreationCard'>
        ...
        <div className='RecreationCardBody'>
            <div className='heading'>
                <Typography variant='body2' style={{marginRight:'0.5rem', color:'darkslategray'}}>Total Reward: 2000</Typography>
               
                <div className="vertical-divider"></div>

                <Typography variant='body2' style={{marginLeft:'0.5rem', color:'darkslategray'}}>2nd August 2022</Typography>
            </div>
            <div className='RecreationContent'>
                <Typography onClick={() => props.addActivity()} style={{fontSize:'1.2rem', marginTop:'2rem', color:'darkslategray'}} variant='body1'>Industry Event</Typography>
                <Typography onClick={() => props.addActivity()} style={{marginTop:'0.5rem', marginRight:'20rem', color:'darkslategray'}} variant='body2'>Learn about all the new technologies</Typography>
