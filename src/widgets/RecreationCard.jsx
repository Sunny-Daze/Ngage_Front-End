    ...
    <div className='RecreationCard'>
        ...
        <div className='RecreationCardBody'>
            ...
            <div className='RecreationContent'>
                <Typography style={{fontSize:'1.2rem', marginTop:'2rem'}} variant='body1'>Industry Event</Typography>
                <Typography style={{marginTop:'0.5rem', marginRight:'20rem'}} variant='body2'>Learn about all the new technologies</Typography>
                <Button style={{fontSize:'14px', background:'#001f54', height:'30px', width:'7.5rem', marginTop:'0.8rem', textTransform:'none'}} variant="contained">Participate<ChevronRightIcon /></Button>
            </div>
        </div>
    </div>
  )
