  ...
  return (
    <div className="ProjectTaskCard">
      <div className="ProjectTaskCardHeading">
        ...
        <div className="ProjectTaskStatus">
          ...
          <Box style={{ paddingTop: "0.5rem", display: "flex" }}>
            ...
            />
            <Typography variant="body2">{formatDate(new Date(task.createdAt))}</Typography>
          </Box>
          <Divider
            style={{
              marginLeft: "1rem",
          ...
          <div className="ProjectTaskCardPriority PTCHigh">
            <Typography style={{ fontSize: "0.7rem" }} variant="body2">
              High
            </Typography>
          </div>
      ...
      <div className="ProjectTaskCardBody">
        <Typography
          variant="h5"
          style={{ fontWeight: "540", fontSize: "1.2rem", marginTop: "1rem" }}
        >
          {task.title}
        </Typography>
      ...
      <div className="ProjectTaskCardFooter">
        <Button
          ...
          endIcon={<ChevronRightIcon style={{ marginBottom: "0.2rem" }} />}
          variant="outlined"
          size="small"
          style={{
            marginTop: "1rem",
