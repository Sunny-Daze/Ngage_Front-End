...
import "./ActivityContentBanner.css";
...
function ActivityContentBanner(props) {
  return (
    <>
      <Box sx={{ minWidth: 800 }}>
            ...
            <div className="ActivityContentCardBody">
              <div className="left">
                ...
                <Typography
                  ...
                  variant="body2"
                >
                  Total Milestones: {props.milestones}
                </Typography>
              </div>
              <div className="right">
                <div className="Activity-Content-right-container ">
...
export default ActivityContentBanner;
